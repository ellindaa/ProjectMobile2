...
package id.ellinda.eljetnews.data.posts.impl

import id.ellinda.eljetnews.R
import id.ellinda.eljetnews.model.Markup
import id.ellinda.eljetnews.model.MarkupType
import id.ellinda.eljetnews.model.Metadata
import id.ellinda.eljetnews.model.Paragraph
import id.ellinda.eljetnews.model.ParagraphType
import id.ellinda.eljetnews.model.Post
import id.ellinda.eljetnews.model.PostAuthor
import id.ellinda.eljetnews.model.PostsFeed
import id.ellinda.eljetnews.model.Publication

/**
 * Define hardcoded posts to avoid handling any non-ui operations.
 */

val pietro = PostAuthor("Ellinda", "https://medium.com/@ellinda")
val manuel = PostAuthor("Maharani", "https://medium.com/@maharani")
val florina = PostAuthor(
    "Febi Maharani",
    "https://medium.com/@febi.maharani"
)
val jose =
    PostAuthor("Stevani Buring", "https://medium.com/@stevani.buring")
