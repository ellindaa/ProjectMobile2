...
import id.ellinda.eljetnews.data.posts.impl.post1
import id.ellinda.eljetnews.data.posts.impl.post2
import id.ellinda.eljetnews.data.posts.impl.post3
import id.ellinda.eljetnews.data.posts.impl.post4
import id.ellinda.eljetnews.data.posts.impl.post5
